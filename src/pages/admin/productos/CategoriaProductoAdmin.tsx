...
const CategoriaProductoAdmin: React.FC = () => {
  ...
  const servicio = new CategoriaProductoService();
  ...
  const manejarSubmit = (e: React.FormEvent) => {
    ...
    const datos: CategoriaProducto = { nombre };
  ...
  const manejarEditar = (categoria: CategoriaProducto) => {
  ...
  return (
    <div className="container my-5">
      <h2 className="mb-4 text-success text-center">
        Administrar Categorías de Producto
      </h2>
...
export default CategoriaProductoAdmin;
